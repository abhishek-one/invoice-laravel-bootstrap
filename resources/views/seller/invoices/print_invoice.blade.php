...
<div class="invoice-div" style="padding-top: 20%;">
    <div class="invoice-qr-div">
        ...
        <div class="qr-div column">
            <img src="{{$qr}}" alt="QR Code" width="50%" style="float:right; padding:0%">
        </div>
        <div class="clearfix"></div>
    </div>

    <div class="seller-buyer-div">
        <div class="seller-div column" style="width: 49%;margin-right:1%">
            <table>
                <tr>
        ...
        <div class="buyer-div column" style="width: 49%;margin-left:1%">
